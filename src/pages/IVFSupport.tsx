            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <p className="text-lg text-muted-foreground">
                  {t('ivfSupport.description')} Our experienced nurses also provide <Link to="/iv-drips-prague" className="text-primary hover:underline font-medium">vitamin IV drip therapy Prague</Link> to support your overall wellness during treatment.
                </p>

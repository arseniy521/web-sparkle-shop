      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/uk/ivf-support-prague" element={<LanguageWrapper language="uk"><IVFSupport /></LanguageWrapper>} />
            <Route path="/uk/iv-drips-prague" element={<LanguageWrapper language="uk"><IVDripTherapy /></LanguageWrapper>} />
